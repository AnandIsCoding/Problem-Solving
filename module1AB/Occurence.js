function countOccurrences(str, char) {
    ...
    // regExp with global search flag
    const regex = new RegExp(char, 'g'); 
    const matches = str.trim().match(regex);  // Find all matches
    return matches ? matches.length : 0; // Return the number of matches, or 0 if no matches
}

console.log(countOccurrences("Almabetter", "a")); // 1
console.log(countOccurrences("hello world", "l")); // 3
console.log(countOccurrences("Elephant", "E")); // 2
